...
function TitlePage() {
    ...
    const startAsGuest = async ()=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInAnonymously();
        if (error) {
            console.error(error);
            return;
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0494cfc5._.js.map